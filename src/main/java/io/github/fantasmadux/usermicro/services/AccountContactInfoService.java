...
import io.github.fantasmadux.usermicro.api.dto.requests.ContactInfoDeleteRequestDto;
import io.github.fantasmadux.usermicro.api.dto.requests.ContactInfoUpdateListRequestDto;
import io.github.fantasmadux.usermicro.api.dto.responses.ContactsListResponseDto;
import io.github.fantasmadux.usermicro.api.exceptions.AccountNotFoundException;
import io.github.fantasmadux.usermicro.api.exceptions.ContactsLimitException;
import io.github.fantasmadux.usermicro.api.exceptions.FieldValidationException;
...
import io.github.fantasmadux.usermicro.validators.ContactInfoValidator;
...
public class AccountContactInfoService {
    ...
    public void deleteContactInfoMethod(UUID accountId, ContactInfoDeleteRequestDto request) {
        ...
        List<AccountContactInfoEntity> contactsToDelete = new ArrayList<>();
        ...
        for (AccountContactInfoEntity contact : contactsToDelete) {
